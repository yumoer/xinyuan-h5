<template>
  <el-col class="info_content container" >
    ...
    <div class="content_project row" :data="foreacharr">  <!--<router-link :to="{path:'/news',query:{ id:item.NewsID }}" class="around"></router-link>-->
      <a href="javascript:;" class="project col-lg-6 col-xs-12" v-for="(construction,index) in underconstruction" :key="index" v-if="index<currentPage*pagesize" @click="$router.push('/residential/underconstructiondetails?'+construction.id)">
        <div class="project_left">
          <img :src="construction.projectImage" alt="">
          <!--<img src="../../../assets/zhuzhai1.png" alt="">-->
        </div>
        <div class="project_right">
          <div class="project_name">kv
  ...
  export default {
    ...
    methods:{
      ...
      handleCurrentChange: function (currentPage) {
        ...
        const tabdata = []
        const foreacharr = this.underconstruction.slice((this.currentPage-1)*this.pagesize,this.currentPage*this.pagesize)
        tabdata.push(foreacharr)
        tabdata.forEach((data)=>{
          console.log(data)
          return data
        })
        this.underconstruction = data
